...
train_data = pd.read_csv("/content/Class135B/static/assets/data_files/tweet_emotions.csv")    
training_sentences = []
...
model = load_model("/content/Class135B/static/assets/model_files/Tweet_Emotion.h5")
